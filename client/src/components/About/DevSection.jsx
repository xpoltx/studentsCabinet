    ...
    return (
        <div className='flex flex-col items-center'>
            <div className='relative inset-x-0 top-0 text-center '>
                <p className='text-sky-400 text-6xl font-bold mb-8'>Розробник</p>
            </div>
            <div className='flex flex-col items-center'>
                <div>
                ...
                <div className='text-center'>
                    <p className='text-white font-semibold text-xl '>Полторацький Сергій</p>
                    <p className='text-white font-light text-lg mb-3'>Менеджер проекту, розробник, тестувальник</p>
