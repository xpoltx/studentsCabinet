...
import { groups, facultys, payments } from '../hooks/constants'
...
const AccountInfoTable = ({ role, accountData }) => {
    ...
    return (
        <div className='p-5 mt-10 bg-white rounded-lg shadow-md w-2/3 mx-auto'>
            ...
            {role === 'student' ? (<>
                <h1 className='text-2xl font-bold mb-4 text-gray-800 text-center'>Інформація про студента</h1>
                ...
                :
                (<>
                    <h1 className='text-2xl font-bold text-center'>Інформація про викладача</h1>
                    <table className='table-fixed w-full border-collapse border border-gray-300'>
                        <tbody>
